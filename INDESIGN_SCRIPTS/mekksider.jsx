...
var mekkfilerPanel = {
	visDialog: function(){
		...
		var listePanel = win.panel1.add("panel",undefined, undefined,{borderStyle: "sunken"});
		...
		win.infoboks = win.mainpanel.add("statictext",undefined,"Del opp avisa i flere filer. Velg hvilke sider som skal være førsteside i de ulike indesign-filene og endre filnavnene hvis nødvendig.",{multiline:true});
...
mekkfilerPanel.mekkSider = function(sideArray, myFolder){
	var myFolder = myFolder.fullName+"/";
...
// for testing av mekkfilerPanel.jsxinc
